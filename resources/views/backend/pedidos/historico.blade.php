                                ...
                                <tbody> 
                                    ...
                                    <tr>                                 
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#mensajero_modal" onclick="mensajero('{{ route('pedidos.mensajero',$item->id) }}')">
...
@section('myscript')
    ...
    function mensajero(urli)
    {
        ...
        .done(function(result) {
            ...
            {   
                document.getElementById('mensajero_detalle').innerHTML = 'Pedido sin mensajero <hr> <div class="text-center"> <a href="{{ route('mensajeros.index') }}" class="btn btn-primary"> Asignar</a> </div>';
            }   
